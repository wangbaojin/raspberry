<?php
    ...
    function getprepay_id($total_fee,$orderid){
        ...
        $stringA="appid=wx95e15975233070a9&attach=养鸡管家&body=养鸡管家&device_info=WEB&mch_id=1303065401&nonce_str=".$nonce_str."&notify_url=http://www.weixin.qq.com/wxpay/pay.php&out_trade_no=".$out_trade_no."&spbill_create_ip=14.23.150.211&total_fee=".$total_fee."&trade_type=APP"; 
