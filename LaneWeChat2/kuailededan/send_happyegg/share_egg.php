<?php
   ...
   $b = $_GET['order_sn']; 
   $redirect_uri = 'LaneWeChat2/kuailededan/send_happyegg/share_egg.php';
	                       ...
	                       res=JSON.parse(res.body)
			                ...
			                wx.ready(function () {
			                    wx.onMenuShareAppMessage({
								    ...
								    link: 'http://weixin.yangjiguanjia.com/LaneWeChat2/kuailededan/send_happyegg/receive_info.php?order_sn='+"<?php echo $order_sn;?>", // 分享链接
