...
! function(e, t) {
	...
	return function(e) {
			...
			for (var t = l["default"].extend({
				...
				for (var u = month1; u < month1+3; u++) {
					if(u==month1){
							...
							for (var d = [], date = date1+6-day1; date < i[u] + 1; date+=7) {
									var c = {
									label: date + "日(周六)",
									value: date
									};
					...
					if(u==month1+1){
						myDate.setFullYear(2017,month1+1,1);
						var date2=myDate.getDate();
						var month2=myDate.getMonth();
						var day2=myDate.getDay();
						for (var d = [], date = date2+6-day2; date < i[u] + 1; date+=7) {
								var c = {
								label: date + "日(周六)",
								value: date
								};
					...
					if(u==month1+2){
						myDate.setFullYear(2017,month1+2,1);
						var date3=myDate.getDate();
						var month3=myDate.getMonth();
						var day3=myDate.getDay();
						for (var d = [], date = date3+6-day3; date < i[u] + 1; date+=7) {
								var c = {
								label: date + "日(周六)",
								value: date
								};
					...
					// for (var d = [], date = 1; date < i[u] + 1; date++) {
					// 	if(u==0&&(date==1||date==8||date==15||date==22||date==29)){
					// 		var c = {
					// 		label: date + "日(周日)",
					// 		value: date
					// 		};
		...
		e.exports = "<div> <div class=weui-mask></div> <div class=weui-picker> <div class=weui-picker__hd> <a href=javascript:; data-action=cancel class=weui-picker__action>取消</a> <span>选择配送时间</span> <a href=javascript:; data-action=select class=weui-picker__action id=weui-picker-confirm>确定</a> </div> <div class=weui-picker__bd> </div> </div> </div>"
	}, function(e, t) {
			...
			for (var t = l["default"].extend({
				...
				for (var u = month1; u < month1+3; u++) {
					if(u==month1){
							...
							for (var d = [], date = date1+7-day1; date < i[u] + 1; date+=7) {
									var c = {
									label: date + "日(周日)",
									value: date
									};
					...
					if(u==month1+1){
						...
						var month2=myDate.getMonth();
						var day2=myDate.getDay();
						for (var d = [], date = date2+7-day2; date < i[u] + 1; date+=7) {
								var c = {
								label: date + "日(周日)",
								value: date
								};
					...
					if(u==month1+2){
						...
						var month3=myDate.getMonth();
						var day3=myDate.getDay();
						for (var d = [], date = date3+7-day3; date < i[u] + 1; date+=7) {
								var c = {
								label: date + "日(周日)",
								value: date
								};
