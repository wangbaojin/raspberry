...
$input->SetNotify_url("http://weixin.yangjiguanjia.com/wxpay2/example/notify2.php");
			...
			//回调
				...
				WeixinJSBridge.log(res.err_msg);
                                if(res.err_msg == "get_brand_wcpay_request:ok")                                  {   
                                   ...
                                   location.href="http://weixin.yangjiguanjia.com/LaneWeChat2/kuailededan/send_happyegg/share_egg.php?order_sn=<?php echo $_GET['order_sn'];?>";
                                 }else{   
